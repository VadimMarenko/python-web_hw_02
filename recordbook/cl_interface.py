from recordbook.user_interface import AbstractUserInterface
from recordbook.record_classes import AddressBook, book
from recordbook.note_classes import NoteBook, n_book
